            ...
            <div class="left_cage">
                <div class="dataAllBorder01 cage_cl" style="margin-top: 9% !important; height: 24%;">
                    <video autoplay="autoplay" loop="loop" class="dataAllBorder02 video_cage">
                        <source class="video" title="主监控位" src="@/assets/screen/video/test_mv02.mp4"/>
                    </video>
                </div>
                <div class="dataAllBorder01 cage_cl" style="margin-top: 1.5% !important; height: 38%;">
                    <div class="dataAllBorder02 video_cage">
                        <img class="video_around video_around_chose" src="@/assets/screen/video/video.jpg">
                        <img class="video_around" src="@/assets/screen/video/video.jpg">
                        <img class="video_around" src="@/assets/screen/video/video.jpg">
                        <img class="video_around" src="@/assets/screen/video/video.jpg">
...
<script>
import "@/assets/screen/css/BigData.css"
import "@/assets/screen/css/index01.css"
import "@/assets/screen/css/index.css"
import "@/assets/screen/css/Security_operation.css"
import "@/assets/screen/js/Home_page.js"
import "@/assets/screen/js/laydate.js"
// import "http://api.map.baidu.com/api?v=2.0&ak=5ieMMexWmzB9jivTq6oCRX9j&callback"
export default {
    name: 'page3',
    mounted(){
        this.initMap();
