            ...
            <el-card shadow="never">
                <el-form
                    ...
                    <el-form-item prop="checkPass" label="确认密码">
                        <el-input type="password" v-model="dataForm.checkPass" placeholder="确认密码"/>
                    </el-form-item>
                ...
                <router-link :to="{path:'login'}"> 
                    <el-button @click="" style="margin-left:24%;">{{ $t('cancel') }}</el-button>
                    <el-button type="primary" @click="submitForm(dataForm)" style="margin-left:7%;">注册用户</el-button>
                </router-link>
                <!-- <el-button type="primary" @click="submitForm(dataForm)" style="margin-left:7%;">注册用户</el-button> -->
            </el-card>
          </div>
    ...
    submitForm: debounce(
      function() {
        this.$refs["dataForm"].validate(valid => {
          ...
          this.$axios.post(`/api/sys/user/register?token=${cookieGet("token")}`,{...this.dataForm})
            .then(res => {
              this.$message({
                message: '注册成功',
                type: "success",
