<template>
  <d2-container>
    <el-form :inline="true" size="mini" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item>
        <el-input v-model="dataForm.name" :placeholder="$t('model.name')" clearable/>
      </el-form-item>
      <el-form-item>
        <el-input v-model="dataForm.key" :placeholder="$t('model.key')" clearable/>
      </el-form-item>
      <el-form-item>
    ...
    <el-table
      ...
      <el-table-column prop="name" :label="$t('model.name')" header-align="center" align="center"/>
      <el-table-column prop="key" :label="$t('model.key')" header-align="center" align="center"/>
      <el-table-column prop="version" :label="$t('model.version')" header-align="center" align="center"/>
      <el-table-column prop="createTime" :label="$t('model.createTime')" header-align="center" align="center" width="180"/>
      <el-table-column prop="lastUpdateTime" :label="$t('model.lastUpdateTime')" header-align="center" align="center" width="180"/>
      <el-table-column :label="$t('handle')" fixed="right" header-align="center" align="center" width="150">
        <template slot-scope="scope">
          ...
          <el-button type="text" size="mini" @click="deployHandle(scope.row.id)">{{ $t('model.deploy') }}</el-button>
