            ...
            <el-table
              ...
              <el-table-column :label="$t('handle')" fixed="right" header-align="center" align="center">
                <template slot-scope="scope">
                  ...
                  <el-button type="primary" size="mini" @click="startRecord(scope.row.id,scope.row.cameraName,scope.row.cameraLocation)">修改</el-button>
                  <el-button type="primary" size="mini" @click="startRecord(scope.row.id,scope.row.cameraName,scope.row.cameraLocation)">删除</el-button>
                </template>
              </el-table-column>
            </el-table>
          </div>
