...
<script>
import '@/assets/h5s/js/adapter.js'
import {H5sPlayerWS,H5sPlayerHls,H5sPlayerRTC} from '@/assets/h5s/js/h5splayer.js'
import {H5siOS,H5sPlayerCreate} from '@/assets/h5s/js/h5splayerhelper.js'
export default {
    name: 'liveplayer',
    ...
    methods: {
        PlayVideo(token)
        {
            ...
            var root = "http://221.231.13.230:10080/";
            var wsroot = "221.231.13.230:10080";
